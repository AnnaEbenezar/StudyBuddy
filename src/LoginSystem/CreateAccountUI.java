...
public class CreateAccountUI extends JPanel {
    ...
    private boolean checkUsername() {
        int checkResult = mainUI.driver.checkUsername(usernameField.getText());
        switch (checkResult) {
            case LoginDriver.CHECK_PATTERN_ERROR -> {
                usernameError.setText("Username can only contain a-z, A-Z, 0-9, and _(underscore).");
                return false;
            }
            case LoginDriver.CHECK_DUPLICATE -> {
                usernameError.setText("Duplicate username. Please select another username.");
                return false;
            }
            case LoginDriver.CHECK_TOO_LONG -> {
                usernameError.setText("Username must be 20 characters or fewer.");
                return false;
            }
            case LoginDriver.CHECK_TOO_SHORT -> {
                usernameError.setText("Username must be at least 6 characters.");
                return false;
            }
            default -> {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel2.add(createAccountButton, gbc);
        ...
        gbc.gridy = 5;
        gbc.anchor = GridBagConstraints.WEST;
        panel3.add(confirmPasswordError, gbc);
