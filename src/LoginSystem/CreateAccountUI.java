...
public class CreateAccountUI extends JPanel {
    ...
    private boolean confirmPassword() {
        boolean check = String.valueOf(confirmPasswordField.getPassword()).equals(String.valueOf(passwordField.getPassword()));
        if (!check) {
            confirmPasswordError.setText("This does not match with your password.");
        } else {
    ...
    private boolean confirmName() {
        if (nameField.getText().isBlank()) {
            nameError.setText("Firstname cannot be empty.");
            return false;
        } else {
            nameError.setText(" ");
            return true;
    ...
    private boolean confirmLastName() {
        if (lastnameField.getText().isBlank()) {
            lastNameError.setText("Lastname cannot be empty.");
            return false;
        } else {
